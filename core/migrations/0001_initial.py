    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direccion_tipo', models.CharField(choices=[('B', 'Billing'), ('S', 'Shipping')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('envio_direccion', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='shipping_address', to='core.address')),
                ('factura_direccion', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='billing_address', to='core.address')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
